...
Loading textures and audio always seemed like a PITA when it comes to web games. So I created this simple JS script to take care of that.
As you can see it follow the KISS ethos of programming. Hope you find it useful.
-Chroma
